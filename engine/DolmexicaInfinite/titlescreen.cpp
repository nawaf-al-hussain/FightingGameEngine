...
static void loadTitleScreen() {
        ...
        logg("[TITLE] loadMenuHeader...");
        loadMenuHeader();
        logg("[TITLE] loadDemoHeader...");
        loadDemoHeader();
        logg("[TITLE] loadScriptBackground...");
        ...
        logg("[TITLE] loadCredits...");
        loadCredits();

        logg("[TITLE] loadTitleMusic...");
        loadTitleMusic();
...
static void updateTitleScreenSafe() {
        logg("[TITLE] update: itemSelection...");
        updateItemSelection();
        logg("[TITLE] update: menuBasePosition...");
        updateMenuBasePosition();
        logg("[TITLE] update: menuElementPositions...");
        updateMenuElementPositions();
        logg("[TITLE] update: selectionBox...");
        updateSelectionBox();
        logg("[TITLE] update: itemSelectionConfirmation...");
        updateItemSelectionConfirmation();
        logg("[TITLE] update: demoMode...");
        updateDemoMode();
        logg("[TITLE] update: done.");
}

static Screen gDreamTitleScreen;

Screen* getDreamTitleScreen() {
        gDreamTitleScreen = makeScreen(loadTitleScreen, updateTitleScreenSafe, NULL, unloadTitleScreen);
