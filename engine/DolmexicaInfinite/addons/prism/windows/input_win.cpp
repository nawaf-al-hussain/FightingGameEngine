...
namespace prism {
        ...
        int hasPressedASingle(int i) {
                int ext = getExternalInputButtonSingle(i, CONTROLLER_A_PRISM);
                if (ext >= 0) return ext;
        ...
        int hasPressedBSingle(int i) {
                int ext = getExternalInputButtonSingle(i, CONTROLLER_B_PRISM);
                if (ext >= 0) return ext;
        ...
        int hasPressedXSingle(int i) {
                int ext = getExternalInputButtonSingle(i, CONTROLLER_X_PRISM);
                if (ext >= 0) return ext;
        ...
        int hasPressedYSingle(int i) {
                int ext = getExternalInputButtonSingle(i, CONTROLLER_Y_PRISM);
                if (ext >= 0) return ext;
        ...
        int hasPressedLeftSingle(int i) {
                int ext = getExternalInputButtonSingle(i, CONTROLLER_LEFT_PRISM);
                if (ext >= 0) return ext;
        ...
        int hasPressedRightSingle(int i) {
                int ext = getExternalInputButtonSingle(i, CONTROLLER_RIGHT_PRISM);
                if (ext >= 0) return ext;
        ...
        int hasPressedUpSingle(int i) {
                int ext = getExternalInputButtonSingle(i, CONTROLLER_UP_PRISM);
                if (ext >= 0) return ext;
        ...
        int hasPressedDownSingle(int i) {
                int ext = getExternalInputButtonSingle(i, CONTROLLER_DOWN_PRISM);
                if (ext >= 0) return ext;
        ...
        int hasPressedLSingle(int i) {
                int ext = getExternalInputButtonSingle(i, CONTROLLER_L_PRISM);
                if (ext >= 0) return ext;
        ...
        int hasPressedRSingle(int i) {
                int ext = getExternalInputButtonSingle(i, CONTROLLER_R_PRISM);
                if (ext >= 0) return ext;
        ...
        int hasPressedStartSingle(int i) {
                int ext = getExternalInputButtonSingle(i, CONTROLLER_START_PRISM);
                if (ext >= 0) return ext;
