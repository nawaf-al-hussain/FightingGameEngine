...
#pragma warning( pop )
        ...
        TruetypeFont loadTruetypeFont(const char* tName, double tSize)
        {
                ...
                // Read font file into memory, then create SDL_RWops for SDL_ttf.
                // This avoids double path resolution (getFullPath called by both
                // loadTruetypeFont and fileToBuffer) which produces invalid paths.
                ...
                if (!rw) {
                        logWarningFormat("SDL_RWFromMem failed: %s", SDL_GetError());
                ...
                // Buffer memory is intentionally leaked — FreeType may reference it.
                // Fonts are loaded once and live for the session.
                return font;
        }
