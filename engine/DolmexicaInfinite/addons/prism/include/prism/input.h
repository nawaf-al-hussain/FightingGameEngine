...
// External input accessor — returns 1/0 if external input is active for
// controller i and button is pressed/not, or -1 if external input is not
// active (fall back to SDL keyboard).
